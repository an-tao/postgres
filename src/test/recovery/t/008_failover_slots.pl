...
$node_master->safe_psql('postgres',
"SELECT pg_create_physical_replication_slot('bb_phys_failover', true);");
$node_master->safe_psql('postgres',
...
$node_master->safe_psql('postgres',
"SELECT pg_create_physical_replication_slot('ab_phys_failover', true);"
);
...
"SELECT pg_create_physical_replication_slot('onreplica', true);"
);
...
# slot.
$node_replica->safe_psql('postgres',
"SELECT pg_create_physical_replication_slot('replace_me', false);");
...
$node_master->safe_psql('postgres',
"SELECT pg_create_physical_replication_slot('replace_me', true);");
